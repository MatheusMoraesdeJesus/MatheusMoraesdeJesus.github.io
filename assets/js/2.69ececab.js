    ...
    [2], {
        148: function(t, e, n) {
            ...
            function d(t, e, n) {
                ...
                for (let e = 0; e < t.length; e++)
                    if (o(t[e].regularPath) === s) return Object.assign({}, t[e], {
                        type: "page",
                        path: h(t[e].path)
                    });
            ...
            function f(t, e, n, s) {
                const {
                    pages: i,
                    themeConfig: a
                } = n, r = s && a.locales && a.locales[s] || a;
                if ("auto" === (t.frontmatter.sidebar || r.sidebar || a.sidebar)) return g(t);
                ...
                if (o) {
                    const {
                        ...
                        for (const s in e)
                            if (0 === (n = t, /(\.html|\/)$/.test(n) ? n : n + "/").indexOf(encodeURI(s))) return {
                                base: s,
                                config: e[s]
                            };
                        var n;
                    ...
                    return "auto" === s ? g(t) : s ? s.map(t => function t(e, n, s, i = 1) {
                        if ("string" == typeof e) return d(n, e, s);
                        if (Array.isArray(e)) return Object.assign(d(n, e[0], s), {
                            title: e[1]
                        }); {
                            const a = e.children || [];
                            return 0 === a.length && e.path ? Object.assign(d(n, e.path, s), {
                                title: e.title
                            }) : {
                                type: "group",
                                path: e.path,
            ...
            function m(t) {
                let e;
                return (t = t.map(t => Object.assign({}, t))).forEach(t => {
        ...
        167: function(t, e, n) {
            ...
            var s = n(148),
                i = {
                    name: "SidebarGroup",
                    components: {
                        DropdownTransition: n(168).a
                    },
                    props: ["item", "open", "collapsable", "depth"],
                    beforeCreate() {
                        this.$options.components.SidebarLinks = n(167).default
                    },
                    methods: {
                        isActive: s.e
                    }
                ...
                r = Object(a.a)(i, (function() {
                    ...
                    return n("section", {
                        ...
                        class: {
                            open: t.open, active: t.isActive(t.$route, t.item.path)
                        },
                        attrs: {
                            to: t.item.path
                        },
            ...
            function l(t, e, n, i, a, r = 1) {
                return !e || r > a ? null : t("ul", {
                    class: "sidebar-sub-headers"
                }, e.map(e => {
                    const u = Object(s.e)(i, n + "#" + e.slug);
                    return t("li", {
                        class: "sidebar-sub-header"
                    }, [o(t, n + "#" + e.slug, e.title, u, e.level - 1), l(t, e.children, n, i, a, r + 1)])
                }))
            }
            var u = {
                functional: !0,
                ...
                render(t, {
                    ...
                    const h = Object(s.e)(i, u.path),
                        p = "auto" === u.type ? h || u.children.some(t => Object(s.e)(i, u.basePath + "#" + t.slug)) : h,
                        d = "external" === u.type ? function(t, e, n) {
                            return t("a", {
                                attrs: {
                                    href: e,
                                    target: "_blank",
                        ...
                        }(t, u.path, u.title || u.path) : o(t, u.path, u.title || u.path, p),
                        f = [e.frontmatter.sidebarDepth, c, r.sidebarDepth, a.sidebarDepth, 1].find(t => void 0 !== t),
                        g = r.displayAllHeaders || a.displayAllHeaders;
                    if ("auto" === u.type) return [d, l(t, u.children, u.basePath, i, f)];
                    if ((p || g) && u.headers && !s.d.test(u.path)) {
                        return [d, l(t, Object(s.c)(u.headers), u.path, i, f)]
                    }
                    return d
                }
            };
            ...
            function c(t, e) {
                return "group" === e.type && e.children.some(e => "group" === e.type ? c(t, e) : "page" === e.type && Object(s.e)(t, e.path))
            }
            var h = {
                    name: "SidebarLinks",
                    components: {
        ...
        177: function(t, e, n) {
            var s = n(4),
                ...
                a = n(3);
            t.exports = function(t) {
                return "string" == typeof t || !i(t) && a(t) && "[object String]" == s(t)
            }
        },
        178: function(t, e, n) {
            "use strict";
        ...
        187: function(t, e, n) {
            ...
            var s = n(148),
                i = {
                    ...
                    computed: {
                        ...
                        exact() {
                            return this.$site.locales ? Object.keys(this.$site.locales).some(t => t === this.link) : "/" === this.link
                        },
                        isNonHttpURI() {
                        ...
                        target() {
                            return this.isNonHttpURI ? null : this.item.target ? this.item.target : Object(s.f)(this.link) ? "_blank" : ""
                        },
                        rel() {
                ...
                l = (n(169), Object(a.a)(o, (function() {
                    ...
                    return n("main", {
                        staticClass: "home",
                        attrs: {
                            "aria-labelledby": null !== t.data.heroText ? "main-title" : null
                        }
                    }, [n("header", {
                        staticClass: "hero"
                    ...
                    }) : t._e(), t._v(" "), null !== t.data.heroText ? n("h1", {
                        attrs: {
                            id: "main-title"
                        }
                    }, [t._v("\n      " + t._s(t.data.heroText || t.$title || "Hello") + "\n    ")]) : t._e(), t._v(" "), null !== t.data.tagline ? n("p", {
                        staticClass: "description"
                    }, [t._v("\n      " + t._s(t.data.tagline || t.$description || "Welcome to your VuePress site") + "\n    ")]) : t._e(), t._v(" "), t.data.actionText && t.data.actionLink ? n("p", {
                        staticClass: "action"
                    }, [n("NavLink", {
                    ...
                    }, t._l(t.data.features, (function(e, s) {
                        return n("div", {
                            key: s,
                            staticClass: "feature"
                ...
                h = (t, e, n = null) => {
                    let s = c()(e, "title", "");
                    return c()(e, "frontmatter.tags") && (s += " " + e.frontmatter.tags.join(" ")), n && (s += " " + n), p(t, s)
                };
            const p = (t, e) => {
                const n = t => t.replace(/[-/\\^$*+?.()|[\]{}]/g, "\\$&"),
                    s = new RegExp("[^\0-]"),
                    i = t.split(/\s+/g).map(t => t.trim()).filter(t => !!t);
                if (s.test(t)) return i.some(t => e.toLowerCase().indexOf(t) > -1); {
                    const s = t.endsWith(" ");
                    return new RegExp(i.map((t, e) => i.length !== e + 1 || s ? `(?=.*\\b${n(t)}\\b)` : `(?=.*\\b${n(t)})`).join("") + ".+", "gi").test(e)
                }
            };
            var d = {
                    name: "SearchBox",
                    ...
                    computed: {
                        ...
                        suggestions() {
                            ...
                            const {
                                pages: e
                            } = this.$site, n = this.$site.themeConfig.searchMaxSuggestions || 5, s = this.$localePath, i = [];
                            for (let a = 0; a < e.length && !(i.length >= n); a++) {
                                const r = e[a];
                                if (this.getPageLocalePath(r) === s && this.isSearchable(r))
                                    if (h(t, r)) i.push(r);
                                    else if (r.headers)
                                    for (let e = 0; e < r.headers.length && !(i.length >= n); e++) {
                                        const n = r.headers[e];
                                        n.title && h(t, r, n.title) && i.push(Object.assign({}, r, {
                                            path: r.path + "#" + n.slug,
                                            header: n
                                        }))
                                    }
                    ...
                    methods: {
                        ...
                        isSearchable(t) {
                            let e = null;
                            return null === e || (e = Array.isArray(e) ? e : new Array(e), e.filter(e => t.path.match(e)).length > 0)
                        },
                        onHotkey(t) {
                ...
                f = (n(170), Object(a.a)(d, (function() {
                    ...
                    return n("div", {
                        ...
                        on: {
                            ...
                            keyup: [function(e) {
                                ...
                                return !e.type.indexOf("key") && t._k(e.keyCode, "up", 38, e.key, ["Up", "ArrowUp"]) ? null : t.onUp(e)
                            }, function(e) {
                                return !e.type.indexOf("key") && t._k(e.keyCode, "down", 40, e.key, ["Down", "ArrowDown"]) ? null : t.onDown(e)
                            }]
                        }
                    ...
                    }, t._l(t.suggestions, (function(e, s) {
                        return n("li", {
                            key: s,
                            staticClass: "suggestion",
                            class: {
                                focused: s === t.focusIndex
                            },
                            on: {
                ...
                k = (n(173), {
                            ...
                            return n("div", {
                                ...
                                return n("li", {
                                    ...
                                    return n("li", {
                                        ...
                                        on: {
                                            focusout: function(n) {
                                                t.isLastItemOfArray(s, e.items) && t.isLastItemOfArray(e, t.item.items) && t.setOpen(!1)
                                            }
                                        }
                                    })], 1)
                                })), 0) : n("NavLink", {
                    ...
                    computed: {
                            ...
                            if (t && Object.keys(t).length > 1) {
                                const e = this.$page.path,
                                    ...
                                    i = {
                                        ...
                                        items: Object.keys(t).map(i => {
                                            const a = t[i],
                                                r = s[i] && s[i].label || a.lang;
                                            let o;
                                            return a.lang === this.$lang ? o = e : (o = e.replace(this.$localeConfig.path, i), n.some(t => t.path === o) || (o = i)), {
                                                text: r,
                                                link: o
                                            }
                                        })
                                    };
                                return [...this.userNav, i]
                            }
                            return this.userNav
                        },
                        userLinks() {
                            return (this.nav || []).map(t => Object.assign(Object(s.j)(t), {
                        ...
                        repoLink() {
                            ...
                            return t ? /^https?:/.test(t) ? t : "https://github.com/" + t : null
                        },
                        repoLabel() {
                            ...
                            for (let n = 0; n < e.length; n++) {
                                const s = e[n];
                                if (new RegExp(s, "i").test(t)) return s
                            }
                            return "Source"
                        }
                    }
                }),
                x = (n(174), Object(a.a)(k, (function() {
                    var t = this,
                        e = t.$createElement,
                        n = t._self._c || e;
            ...
            var C = {
                    ...
                    mounted() {
                        const t = parseInt($(this.$el, "paddingLeft")) + parseInt($(this.$el, "paddingRight")),
                            e = () => {
                                document.documentElement.clientWidth < 719 ? this.linksWrapMaxWidth = null : this.linksWrapMaxWidth = this.$el.offsetWidth - t - (this.$refs.siteName && this.$refs.siteName.offsetWidth || 0)
                            };
                        e(), window.addEventListener("resize", e, !1)
                    }
                },
                L = (n(175), Object(a.a)(C, (function() {
                    var t = this,
                        e = t.$createElement,
                        n = t._self._c || e;
                    return n("header", {
                ...
                O = {
                    ...
                    computed: {
                        ...
                        editLink() {
                            const t = w()(this.$page.frontmatter.editLink) ? this.$site.themeConfig.editLinks : this.$page.frontmatter.editLink,
                                {
                                    repo: e,
                                    docsDir: n = "",
                                    docsBranch: s = "master",
                            ...
                            return t && i && this.$page.relativePath ? this.createEditLink(e, i, n, s, this.$page.relativePath) : null
                        },
                        editLinkText() {
                    ...
                    methods: {
                        createEditLink(t, e, n, i, a) {
                            if (/bitbucket.org/.test(e)) {
                                return e.replace(s.a, "") + "/src" + `/${i}/` + (n ? n.replace(s.a, "") + "/" : "") + a + `?mode=edit&spa=0&at=${i}&fileviewer=file-view-default`
                            }
                            if (/gitlab.com/.test(e)) {
                                return e.replace(s.a, "") + "/-/edit" + `/${i}/` + (n ? n.replace(s.a, "") + "/" : "") + a
                            }
                            return (s.i.test(e) ? e : "https://github.com/" + e).replace(s.a, "") + "/edit" + `/${i}/` + (n ? n.replace(s.a, "") + "/" : "") + a
                        }
                    }
                },
                S = (n(176), Object(a.a)(O, (function() {
                    var t = this,
                        e = t.$createElement,
                        n = t._self._c || e;
                    return n("footer", {
            ...
            function N(t, {
                ...
                const {
                    ...
                    getPageLinkConfig: u
                } = t, c = l(e), h = u(n), p = w()(h) ? c : h;
                return !1 === p ? void 0 : j()(p) ? Object(s.k)(a.pages, p, i.path) : o(n, r)
            }

            function P(t, e, n) {
                const s = [];
                ! function t(e, n) {
                    for (let s = 0, i = e.length; s < i; s++) "group" === e[s].type ? t(e[s].children || [], n) : n.push(e[s])
                }(e, s);
                for (let e = 0; e < s.length; e++) {
                    const i = s[e];
                    if ("page" === i.type && i.path === decodeURIComponent(t.path)) return s[e + n]
                }
            }
            var A = T,
                D = (n(178), {
                ...
                H = (n(179), Object(a.a)(D, (function() {
                    ...
                    }), t._v(" "), n("PageEdit"), t._v(" "), n("PageNav", t._b({}, "PageNav", {
                        sidebarItems: t.sidebarItems
                    }, !1)), t._v(" "), t._t("bottom")], 2)
                }), [], !1, null, null, null).exports),
                R = {
                    name: "Sidebar",
                    components: {
                        SidebarLinks: n(167).default,
                        NavLinks: x
                    },
                    props: ["items"]
                },
                U = (n(182), {
                    ...
                    computed: {
                        shouldShowNavbar() {
                            ...
                            return !1 !== e.navbar && !1 !== t.navbar && (this.$title || t.logo || t.repo || t.nav || this.$themeLocaleConfig.nav)
                        },
                        shouldShowSidebar() {
                            const {
                                frontmatter: t
                ...
                B = {
                    components: {
                        ParentLayout: Object(a.a)(U, (function() {
                            var t = this,
                                e = t.$createElement,
                                n = t._self._c || e;
                            return n("div", {
                    ...
                    computed: {
                        defaultTheme() {
                            const t = this.$themeConfig.defaultTheme;
                            if ("object" == typeof t) {
                    ...
                    beforeMount() {
                        this.defaultTheme && document.getElementsByTagName("html")[0].setAttribute("theme", this.defaultTheme)
                    }
                },
                G = (n(183), Object(a.a)(B, (function() {
                    var t = this.$createElement;
                    return (this._self._c || t)("ParentLayout")
                }), [], !1, null, null, null));
            e.default = G.exports
        }
    }

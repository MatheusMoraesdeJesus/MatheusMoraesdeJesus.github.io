            ...
            t.exports = function() {
                    ...
                    x = {
                        ...
                        m: function t(e, s) {
                            ...
                            var r = 12 * (s.year() - e.year()) + (s.month() - e.month()),
                                i = e.clone().add(r, a),
                                n = s - i < 0,
                                l = e.clone().add(r + (n ? -1 : 1), a);
                            return +(-(r + (s - i) / (n ? i - l : l - i)) || 0)
                        },
                        a: function(t) {
                ...
                var M = function(t) {
                    ...
                    j = function(t, e, s) {
                        ...
                        return !s && r && (p = r), r || !s && p
                    },
                    k = function(t, e) {
                        if (M(t)) return t.clone();
                        var s = "object" == typeof e ? e : {};
                        return s.date = t, s.args = arguments, new g(s)
                    },
                    v = x;
                v.l = j, v.i = M, v.w = function(t, e) {
                    return k(t, {
                        locale: e.$L,
                        utc: e.$u,
                        x: e.$x,
                ...
                var g = function() {
                        ...
                        return u.parse = function(t) {
                            this.$d = function(t) {
                                ...
                                if ("string" == typeof e && !/Z$/i.test(e)) {
                                    ...
                                    if (r) {
                                        ...
                                        return s ? new Date(Date.UTC(r[1], i, r[3] || 1, r[4] || 0, r[5] || 0, r[6] || 0, n)) : new Date(r[1], i, r[3] || 1, r[4] || 0, r[5] || 0, r[6] || 0, n)
                                    }
                                }
                                return new Date(e)
                            ...
                            return v.u(t) ? this[e] : this.set(s, t)
                        }, u.unix = function() {
                            return Math.floor(this.valueOf() / 1e3)
                        }, u.valueOf = function() {
                            return this.$d.getTime()
                        }, u.startOf = function(t, l) {
                            var d = this,
                                f = !!v.u(l) || l,
                                h = v.p(t),
                                u = function(t, e) {
                                    var s = v.w(d.$u ? Date.UTC(d.$y, e, t) : new Date(d.$y, e, t), d);
                                    return f ? s : s.endOf(i)
                                },
                                x = function(t, e) {
                                    return v.w(d.toDate()[t].apply(d.toDate("s"), (f ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e)), d)
                                },
                                p = this.$W,
                                m = this.$M,
                                M = this.$D,
                            ...
                            switch (h) {
                                ...
                                case a:
                                    return f ? u(1, m) : u(0, m + 1);
                                case n:
                                    var k = this.$locale().weekStart || 0,
                                        g = (p < k ? p + 7 : p) - k;
                                    return u(f ? M - g : M + (6 - g), m);
                                case i:
                                case o:
                                    return x(j + "Hours", 0);
                                case r:
                            ...
                            var d, f = v.p(n),
                                h = "set" + (this.$u ? "UTC" : ""),
                                u = (d = {}, d[i] = h + "Date", d[o] = h + "Date", d[a] = h + "Month", d[c] = h + "FullYear", d[r] = h + "Hours", d[s] = h + "Minutes", d[e] = h + "Seconds", d[t] = h + "Milliseconds", d)[f],
                                x = f === i ? this.$D + (l - this.$W) : l;
                            if (f === a || f === c) {
                                var p = this.clone().set(o, 1);
                                p.$d[u](x), p.init(), this.$d = p.set(o, Math.min(this.$D, p.daysInMonth())).$d
                            } else u && this.$d[u](x);
                            ...
                            var f = v.p(l),
                                h = function(e) {
                                    var s = k(d);
                                    return v.w(s.date(s.date() + Math.round(e * t)), d)
                                };
                            if (f === a) return this.set(a, this.$M + t);
                            if (f === c) return this.set(c, this.$y + t);
                            if (f === i) return h(1);
                            if (f === n) return h(7);
                            var u = (o = {}, o[s] = 6e4, o[r] = 36e5, o[e] = 1e3, o)[f] || 1,
                                x = this.$d.getTime() + t * u;
                            return v.w(x, this)
                            ...
                            var s = t || "YYYY-MM-DDTHH:mm:ssZ",
                                ...
                                o = i.months,
                                d = function(t, r, i, n) {
                                    return t && (t[r] || t(e, s)) || i[r].substr(0, n)
                                },
                                h = function(t) {
                                    return v.s(n % 12 || 12, t, "0")
                                },
                                u = i.meridiem || function(t, e, s) {
                                    var r = t < 12 ? "AM" : "PM";
                            ...
                            return s.replace(f, (function(t, e) {
                                return e || x[t] || r.replace(":", "")
                            }))
                        }, u.utcOffset = function() {
                            return 15 * -Math.round(this.$d.getTimezoneOffset() / 15)
                        }, u.diff = function(t, o, d) {
                            var f, h = v.p(o),
                                u = k(t),
                                x = 6e4 * (u.utcOffset() - this.utcOffset()),
                                p = this - u,
                                m = v.m(this, u);
                            return m = (f = {}, f[c] = m / 12, f[a] = m, f[l] = m / 3, f[n] = (p - x) / 6048e5, f[i] = (p - x) / 864e5, f[r] = p / 36e5, f[s] = p / 6e4, f[e] = p / 1e3, f)[h] || p, d ? m : v.a(m)
                ...
                return k.prototype = y, [
                    ...
                    return t.$i || (t(e, g, k), t.$i = !0), k
                }, k.locale = j, k.isDayjs = M, k.unix = function(t) {
                    return k(1e3 * t)
                }, k.en = m[p], k.Ls = m, k.p = {}, k
            }()
        },
        1541: function(t, e, s) {
            "use strict";
                ...
                l = function(t) {
                    ...
                    return (0, r.jsxs)(c, {
                        ...
                        children: [l, (0, r.jsx)(i.default, {
                            id: "2740265995",
                            dynamic: [s],
                            children: [".root.__jsx-style-dynamic-selector{display:-webkit-box;-webkit-line-clamp:".concat(s, ";-webkit-box-orient:vertical;overflow:hidden;}")]
                        })]
                    })
                }
        },
                ...
                f = function(t) {
                    ...
                    return (0, r.jsxs)(r.Fragment, {
                        children: [e && (0, r.jsxs)("div", {
                            ...
                            children: [(0, r.jsx)("h3", {
                                className: n()("large" === u ? "f4 text-normal text-mono text-uppercase" : "f5 text-normal text-mono underline-dashed color-text-secondary"),
                                children: e
                            }), s && (0, r.jsxs)(c.r, {
                                href: s,
                                className: "ml-4",
                                children: ["View all ", (0, r.jsx)(o.LZ3, {
                                    size: 14,
                            ...
                            children: i.map((function(t) {
                                return (0, r.jsx)("li", {
                                    className: n()("compact" === f && "border-top"),
                                    children: (0, r.jsxs)(c.r, {
                                        href: t.href,
                                        ...
                                        children: [(0, r.jsxs)("h4", {
                                        ...
                                        }), !t.hideIntro && t.intro && (0, r.jsx)(d.u, {
                                            as: "p",
                                            maxLines: "spaced" === f ? 6 : 2,
                                            ...
                                            "aria-label": l()(t.date).format("LLL"),
                                            children: l()(t.date).format("MMMM DD")
                                        })]
                                    })
                                }, t.href)
                            }))
                        ...
                        children: (0, r.jsxs)("div", {
                            ...
                            children: [(0, r.jsx)("h2", {
                                ...
                                children: f.map((function(t) {
                                    var s, i;
                                    if (!h && (null === (s = t.versions) || void 0 === s || !s.includes(m)) && !t.external) return null;
                                    var n = "".concat(t.external ? "" : "/".concat(e.locale)).concat(null !== (i = t.versions) && void 0 !== i && i.includes(m) && !h ? "/".concat(m, "/").concat(t.id) : t.href);
                                    return (0, r.jsx)("div", {
                                        ...
                                        children: (0, r.jsxs)("a", {
                                            ...
                                            children: [t.name, t.external && (0, r.jsx)("span", {
                                                className: "ml-1",
                                                children: (0, r.jsx)(c.Pfi, {})
                                            })]
                                        })
                                    }, t.id)
                                }))
